...
public partial class EmployePretsAvancesPanel : UserControl
{
    private PretsAvancesViewModel? _vm;
    private int _employeId;

    public EmployePretsAvancesPanel()
    {
        InitializeComponent();
    ...
    private void ChargerEmploye(int? employeId)
    {
        ...
        _employeId = id;
        _vm = new PretsAvancesViewModel(new PaieDbContext(), id);
