...
public partial class EmployePrimesPanel : UserControl
{
    private PrimesIndemnitesEmployeViewModel? _vm;
    private int _employeId;

    public EmployePrimesPanel()
    {
        InitializeComponent();
    ...
    private void ChargerEmploye(int? employeId)
    {
        ...
        _employeId = id;
        _vm = new PrimesIndemnitesEmployeViewModel(new PaieDbContext(), id);
